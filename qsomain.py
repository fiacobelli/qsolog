...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.searchLineEdit = QtWidgets.QLineEdit(parent=self.splitter_5)
        ...
        self.logListTableView = QtWidgets.QTableView(parent=self.splitter_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.logListTableView.sizePolicy().hasHeightForWidth())
        self.logListTableView.setSizePolicy(sizePolicy)
        self.logListTableView.setObjectName("logListTableView")
        self.groupBox = QtWidgets.QGroupBox(parent=self.splitter_6)
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.groupBox)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.splitter_9 = QtWidgets.QSplitter(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.splitter_8 = QtWidgets.QSplitter(parent=self.splitter_9)
        self.splitter_8.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.splitter_8.setObjectName("splitter_8")
        self.splitter = QtWidgets.QSplitter(parent=self.splitter_8)
        ...
        self.splitter_4 = QtWidgets.QSplitter(parent=self.splitter_8)
        ...
        self.splitter_2 = QtWidgets.QSplitter(parent=self.splitter_8)
        ...
        self.layoutWidget1 = QtWidgets.QWidget(parent=self.splitter_8)
        ...
        self.commentsPlainTextEdit = QtWidgets.QPlainTextEdit(parent=self.layoutWidget1)
        self.commentsPlainTextEdit.setObjectName("commentsPlainTextEdit")
        self.verticalLayout.addWidget(self.commentsPlainTextEdit)
        self.splitter_7 = QtWidgets.QSplitter(parent=self.splitter_8)
        self.splitter_7.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.splitter_7.setObjectName("splitter_7")
        self.updateButtonBox = QtWidgets.QDialogButtonBox(parent=self.splitter_7)
        ...
        self.saveQSOButtonBox = QtWidgets.QDialogButtonBox(parent=self.splitter_7)
        ...
        self.specialFieldsTabWidget = QtWidgets.QTabWidget(parent=self.splitter_9)
        ...
        self.splitter_11 = QtWidgets.QSplitter(parent=self.generalTabl)
        self.splitter_11.setGeometry(QtCore.QRect(10, 10, 321, 241))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.splitter_11.sizePolicy().hasHeightForWidth())
        self.splitter_11.setSizePolicy(sizePolicy)
        self.splitter_11.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.splitter_11.setObjectName("splitter_11")
        self.layoutWidget2 = QtWidgets.QWidget(parent=self.splitter_11)
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.generalInfoFormLayout = QtWidgets.QFormLayout(self.layoutWidget2)
        self.generalInfoFormLayout.setFieldGrowthPolicy(QtWidgets.QFormLayout.FieldGrowthPolicy.ExpandingFieldsGrow)
        ...
        self.qsoNameLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.qsoGridLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.qsoAddressLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.qsoStateLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.label_25 = QtWidgets.QLabel(parent=self.layoutWidget2)
        self.label_25.setObjectName("label_25")
        self.generalInfoFormLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_25)
        self.qsoCountryLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.latLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.lonLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.lookupPushButton = QtWidgets.QPushButton(parent=self.splitter_11)
        ...
        self.splitter_10 = QtWidgets.QSplitter(parent=self.potaTab)
        self.splitter_10.setGeometry(QtCore.QRect(1, 2, 321, 381))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        ...
        self.splitter_10.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.splitter_10.setObjectName("splitter_10")
        self.layoutWidget3 = QtWidgets.QWidget(parent=self.splitter_10)
        ...
        self.theirParkIDLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget3)
        ...
        self.theirParkNameLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget3)
        ...
        self.potaStateLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget3)
        ...
        self.potaGridLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget3)
        ...
        self.potaLatLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget3)
        ...
        self.potaLonLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget3)
        ...
        self.pushButtonPotaSpots = QtWidgets.QPushButton(parent=self.splitter_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButtonPotaSpots.sizePolicy().hasHeightForWidth())
        self.pushButtonPotaSpots.setSizePolicy(sizePolicy)
        self.pushButtonPotaSpots.setObjectName("pushButtonPotaSpots")
        self.tableViewPotaSpots = QtWidgets.QTableView(parent=self.splitter_10)
        self.tableViewPotaSpots.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tableViewPotaSpots.sizePolicy().hasHeightForWidth())
        self.tableViewPotaSpots.setSizePolicy(sizePolicy)
        self.tableViewPotaSpots.setMinimumSize(QtCore.QSize(0, 192))
        self.tableViewPotaSpots.setObjectName("tableViewPotaSpots")
        self.specialFieldsTabWidget.addTab(self.potaTab, "")
        self.splitTab = QtWidgets.QWidget()
        self.splitTab.setObjectName("splitTab")
        self.layoutWidget4 = QtWidgets.QWidget(parent=self.splitTab)
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 20, 240, 27))
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_19)
        self.frequencyTXDoubleSpinBox = QtWidgets.QDoubleSpinBox(parent=self.layoutWidget4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.frequencyTXDoubleSpinBox)
        ...
        self.layoutWidget5 = QtWidgets.QWidget(parent=self.satelliteTab)
        self.layoutWidget5.setGeometry(QtCore.QRect(20, 20, 241, 61))
        ...
        self.satNameComboBox = QtWidgets.QComboBox(parent=self.layoutWidget5)
        ...
        self.satModeLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget5)
        ...
        self.layoutWidget6 = QtWidgets.QWidget(parent=self.contestTab)
        self.layoutWidget6.setGeometry(QtCore.QRect(10, 10, 341, 121))
        ...
        self.contestNameComboBox = QtWidgets.QComboBox(parent=self.layoutWidget6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.contestNameComboBox.sizePolicy().hasHeightForWidth())
        self.contestNameComboBox.setSizePolicy(sizePolicy)
        ...
        self.arrlSectionLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget6)
        ...
        self.serialRcvLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget6)
        ...
        self.serialSentSpinBox = QtWidgets.QSpinBox(parent=self.layoutWidget6)
        ...
        self.actionMy_Rig.setChecked(True)
        ...
        self.actionPortable_elsewhere = QtGui.QAction(parent=MainWindow)
        self.actionPortable_elsewhere.setCheckable(True)
        self.actionPortable_elsewhere.setObjectName("actionPortable_elsewhere")
        ...
        self.menuM_y_End.addAction(self.actionPortable_elsewhere)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lookupPushButton.setText(_translate("MainWindow", "Lookup in QRZ"))
        ...
        self.pushButtonPotaSpots.setToolTip(_translate("MainWindow", "Push to refresh spots"))
        self.pushButtonPotaSpots.setStatusTip(_translate("MainWindow", "Refreshing pota spots"))
        self.pushButtonPotaSpots.setText(_translate("MainWindow", "Refresh Spots"))
        ...
        self.actionMy_Rig.setToolTip(_translate("MainWindow", "Select if you want to use your default QTH info"))
        self.actionThis_is_a_POTA_activation.setText(_translate("MainWindow", "At a &POTA activation"))
        self.actionThis_is_a_POTA_activation.setToolTip(_translate("MainWindow", "Select to set a park as your QTH"))
        ...
        self.actionPortable_elsewhere.setText(_translate("MainWindow", "Portable elsewhere"))
        self.actionPortable_elsewhere.setToolTip(_translate("MainWindow", "Select to set a different QTH from your default one"))
