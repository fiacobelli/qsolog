...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = QtWidgets.QWidget(parent=self.splitter_10)
        ...
        self.potaStateLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        ...
        self.potaGridLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        ...
        self.potaLatLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        ...
        self.potaLonLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        ...
        self.layoutWidget3 = QtWidgets.QWidget(parent=self.splitTab)
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 20, 240, 27))
        ...
        self.frequencyTXDoubleSpinBox = QtWidgets.QDoubleSpinBox(parent=self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget4 = QtWidgets.QWidget(parent=self.satelliteTab)
        self.layoutWidget4.setGeometry(QtCore.QRect(20, 20, 241, 61))
        ...
        self.satNameComboBox = QtWidgets.QComboBox(parent=self.layoutWidget4)
        ...
        self.satModeLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget4)
        ...
        self.layoutWidget5 = QtWidgets.QWidget(parent=self.contestTab)
        self.layoutWidget5.setGeometry(QtCore.QRect(10, 10, 341, 121))
        ...
        self.contestNameComboBox = QtWidgets.QComboBox(parent=self.layoutWidget5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.arrlSectionLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget5)
        ...
        self.serialRcvLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget5)
        ...
        self.serialSentSpinBox = QtWidgets.QSpinBox(parent=self.layoutWidget5)
