...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.generalInfoTextBrowser = QtWidgets.QTextBrowser(parent=self.tab_3)
        ...
        self.specialFieldsTabWidget.addTab(self.tab_3, "")
        ...
        self.specialFieldsTabWidget.addTab(self.tab_2, "")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.specialFieldsTabWidget.addTab(self.tab, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bandComboBox.setItemText(0, _translate("MainWindow", "2200 (135 kHz)"))
        self.bandComboBox.setItemText(1, _translate("MainWindow", "630 (472 kHz)"))
        self.bandComboBox.setItemText(2, _translate("MainWindow", "160 (1.8 MHz)"))
        self.bandComboBox.setItemText(3, _translate("MainWindow", "80 (3.5 MHz)"))
        self.bandComboBox.setItemText(4, _translate("MainWindow", "60 (5.3 MHz)"))
        self.bandComboBox.setItemText(5, _translate("MainWindow", "40 (7 MHz)"))
        self.bandComboBox.setItemText(6, _translate("MainWindow", "30 (10.1 MHz)"))
        self.bandComboBox.setItemText(7, _translate("MainWindow", "20 (14 MHz)"))
        self.bandComboBox.setItemText(8, _translate("MainWindow", "17 (18 MHz)"))
        self.bandComboBox.setItemText(9, _translate("MainWindow", "15 (21 MHz)"))
        self.bandComboBox.setItemText(10, _translate("MainWindow", "12 (24 MHz)"))
        self.bandComboBox.setItemText(11, _translate("MainWindow", "10 (28 MHz)"))
        self.bandComboBox.setItemText(12, _translate("MainWindow", "6 (50 MHz)"))
        self.bandComboBox.setItemText(13, _translate("MainWindow", "2 (144 MHz)"))
        self.bandComboBox.setItemText(14, _translate("MainWindow", "1.25 (222 MHz)"))
        self.bandComboBox.setItemText(15, _translate("MainWindow", "70 cm (420 MHz)"))
        self.bandComboBox.setItemText(16, _translate("MainWindow", "33 cm (902 MHz)"))
        self.bandComboBox.setItemText(17, _translate("MainWindow", "23 cm (1240 MHz)"))
        self.bandComboBox.setItemText(18, _translate("MainWindow", "SHF & EHF"))
        self.label_4.setText(_translate("MainWindow", "Mode"))
        self.modeComboBox.setItemText(0, _translate("MainWindow", "USB"))
        self.modeComboBox.setItemText(1, _translate("MainWindow", "LSB"))
        self.modeComboBox.setItemText(2, _translate("MainWindow", "AM"))
        self.modeComboBox.setItemText(3, _translate("MainWindow", "FM"))
        self.modeComboBox.setItemText(4, _translate("MainWindow", "DMR"))
        self.modeComboBox.setItemText(5, _translate("MainWindow", "C4FM"))
        self.modeComboBox.setItemText(6, _translate("MainWindow", "DSTAR"))
        self.modeComboBox.setItemText(7, _translate("MainWindow", "OLIVIA"))
        self.modeComboBox.setItemText(8, _translate("MainWindow", "PSK31"))
        self.modeComboBox.setItemText(9, _translate("MainWindow", "FT8"))
        ...
        self.specialFieldsTabWidget.setTabText(self.specialFieldsTabWidget.indexOf(self.tab_3), _translate("MainWindow", "General Info"))
        ...
        self.specialFieldsTabWidget.setTabText(self.specialFieldsTabWidget.indexOf(self.tab_2), _translate("MainWindow", "Satellite"))
        self.specialFieldsTabWidget.setTabText(self.specialFieldsTabWidget.indexOf(self.tab), _translate("MainWindow", "Contest"))
