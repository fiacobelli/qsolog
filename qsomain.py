...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.specialFieldsTabWidget.setGeometry(QtCore.QRect(510, 20, 271, 251))
        ...
        self.qrzCommandLinkButton = QtWidgets.QCommandLinkButton(parent=self.generalTabl)
        self.qrzCommandLinkButton.setGeometry(QtCore.QRect(10, 180, 71, 41))
        self.qrzCommandLinkButton.setObjectName("qrzCommandLinkButton")
        self.mapCommandLinkButton = QtWidgets.QCommandLinkButton(parent=self.generalTabl)
        self.mapCommandLinkButton.setGeometry(QtCore.QRect(180, 180, 71, 41))
        self.mapCommandLinkButton.setObjectName("mapCommandLinkButton")
        self.widget = QtWidgets.QWidget(parent=self.generalTabl)
        self.widget.setGeometry(QtCore.QRect(10, 10, 255, 171))
        ...
        self.qsoNameLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        self.qsoNameLineEdit.setObjectName("qsoNameLineEdit")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.qsoNameLineEdit)
        self.label_21 = QtWidgets.QLabel(parent=self.widget)
        self.label_21.setObjectName("label_21")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_21)
        self.qsoGridLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        self.qsoGridLineEdit.setObjectName("qsoGridLineEdit")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.qsoGridLineEdit)
        self.label_22 = QtWidgets.QLabel(parent=self.widget)
        self.label_22.setObjectName("label_22")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_22)
        self.qsoAddressLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        self.qsoAddressLineEdit.setObjectName("qsoAddressLineEdit")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.qsoAddressLineEdit)
        self.label_23 = QtWidgets.QLabel(parent=self.widget)
        self.label_23.setObjectName("label_23")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_23)
        self.qsoStateLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        self.qsoStateLineEdit.setObjectName("qsoStateLineEdit")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.qsoStateLineEdit)
        ...
        self.qsoCountyLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        self.qsoCountyLineEdit.setObjectName("qsoCountyLineEdit")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.qsoCountyLineEdit)
        ...
        self.qsoCountryLineEdit = QtWidgets.QLineEdit(parent=self.widget)
        self.qsoCountryLineEdit.setObjectName("qsoCountryLineEdit")
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.qsoCountryLineEdit)
        self.specialFieldsTabWidget.addTab(self.generalTabl, "")
        self.potaTab = QtWidgets.QWidget()
        self.potaTab.setObjectName("potaTab")
        self.layoutWidget = QtWidgets.QWidget(parent=self.potaTab)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 199, 164))
        ...
        self.theirParkIDLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.theirParkNameLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.potaStateLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.potaGridLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.potaLatLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.potaLonLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.commandLinkButton = QtWidgets.QCommandLinkButton(parent=self.potaTab)
        self.commandLinkButton.setGeometry(QtCore.QRect(10, 170, 185, 41))
        ...
        self.layoutWidget1 = QtWidgets.QWidget(parent=self.satelliteTab)
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 20, 173, 52))
        ...
        self.satNameComboBox = QtWidgets.QComboBox(parent=self.layoutWidget1)
        ...
        self.satModeLineEdit = QtWidgets.QLineEdit(parent=self.layoutWidget1)
        ...
        self.splitter_4.setGeometry(QtCore.QRect(180, 70, 211, 22))
        ...
        self.bandComboBox = QtWidgets.QComboBox(parent=self.centralwidget)
        self.bandComboBox.setGeometry(QtCore.QRect(76, 350, 120, 22))
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 350, 27, 16))
        self.label_3.setObjectName("label_3")
        self.groupBox.raise_()
        self.splitter_3.raise_()
        self.bandComboBox.raise_()
        self.label_3.raise_()
        ...
        self.specialFieldsTabWidget.setCurrentIndex(0)
        ...
        MainWindow.setTabOrder(self.modeComboBox, self.frequencyDoubleSpinBox)
        MainWindow.setTabOrder(self.frequencyDoubleSpinBox, self.RSTSendLineEdit)
        MainWindow.setTabOrder(self.RSTSendLineEdit, self.lineEdit)
        MainWindow.setTabOrder(self.lineEdit, self.specialFieldsTabWidget)
        ...
        MainWindow.setTabOrder(self.potaGridLineEdit, self.commentsPlainTextEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.qrzCommandLinkButton.setText(_translate("MainWindow", "QRZ"))
        self.mapCommandLinkButton.setText(_translate("MainWindow", "Map"))
        self.label_20.setText(_translate("MainWindow", "Name"))
        self.label_21.setText(_translate("MainWindow", "Grid"))
        self.label_22.setText(_translate("MainWindow", "Address"))
        self.label_23.setText(_translate("MainWindow", "State"))
        self.label_24.setText(_translate("MainWindow", "County"))
        ...
        self.commandLinkButton.setText(_translate("MainWindow", "More Park Details"))
        ...
        self.lineEdit.setToolTip(_translate("MainWindow", "The RST you received from them"))
        self.label_9.setText(_translate("MainWindow", "Frequency"))
        self.frequencyDoubleSpinBox.setToolTip(_translate("MainWindow", "No decimals"))
        ...
        self.bandComboBox.setStatusTip(_translate("MainWindow", "Select the band of this QSO"))
